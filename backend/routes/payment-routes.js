  ...
  async (req, res) => {
    ...
    try {
      ...
      const session = await stripe.checkout.sessions.create({
        ...
        mode:        'payment',
        success_url: `${process.env.FRONTEND_URL}/payment.html?session_id={CHECKOUT_SESSION_ID}&matchId=${matchId}`,
        cancel_url:  `${process.env.FRONTEND_URL}/matches.html?cancelled=true&matchId=${matchId}`,
        metadata: {
          matchId,
          userId:           req.user.id,
